package.path = CS.UnityEngine.Application.dataPath .. "/0/StreamingAssets/Lua/utils/pngLua-master/?.lua"
...
function Stream:__init(param) -- 重写stream代码
    local str = ""
...
function start()
	...
	local data = castleDB:new(CS.UnityEngine.Application.dataPath .. "/0/StreamingAssets/Resource/data/", "data.cdb")
	data:readDB()
...
--~ 				print(v3.x, v3.y)
				...
				table.insert(points, {x = t1x, y = t1y}) -- 右上角

				table.insert(points, {x = t2x, y = t2y}) -- 左下角
